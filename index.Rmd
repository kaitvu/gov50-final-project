...
```{r}
library(readr)
d3 <- read_csv("~/Downloads/GOV50 Data - Sheet1.csv")
...
```{r}
d3 |>
  ggplot(mapping = aes(x = factor(Date), y = unfav_prop)) + 
  geom_point() +
  geom_line(aes(group=1)) +
  labs(
